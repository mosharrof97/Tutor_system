...
class guardianTuitorController extends Controller
{
    // ---------Tuitor View----------//
    ...
    public Function addtuitor( Request $request){
        ...
        return view('guardian.pages.tuitor.addtuitor', $data);
    }
    ...
    public Function store( Request $request ){
        ...
        return Redirect::route('guardian_addtuitor')->with('success', 'tuitor Add successfull');
    }
    ...
    public Function edit($id){
        ...
        return view('guardian.pages.tuitor.updatetuitor', $data);
    }
...
// dd($data);
       ...
       $data = Tuitor::where('tuitor_id', $id)->first();
       $data->save($request->all());
        return Redirect::route('guardian_tuitor')->with('success', 'Tuitor Update Successfull');
    }

    // ---------Delete----------//
    public Function delete( $id){
        Tuitor::where('tuitor_id', $id)->delete();
        return Redirect::route('guardian_tuitor')->with('success', 'Tuitor Delete Successfull');
    }
