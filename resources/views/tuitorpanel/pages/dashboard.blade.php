        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Congratulations Dear Teacher! 🎉</h5>
                            <p class="mb-4">
                    ...
                    <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="../assets/img/illustrations/user-with-laptop-light.jpg" height="140"
                                alt="View Badge User" data-app-dark-img="illustrations/user-with-laptop-light.jpg"
                                data-app-light-img="illustrations/user-with-laptop-light.jpg" />
                        </div>
                    </div>
                </div>
            </div>
