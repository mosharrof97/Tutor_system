...
<footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Home Tutoring</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Group Tutoring</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Online Tutoring</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Package Tutoring</a></li>
    ...
    <div class="container d-md-flex py-4">
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>No Rest DRR Brand</span></strong>. All Rights Reserved-2023
        </div>
        <div class="credits">
          ...
          Designed by <a href="https://bootstrapmade.com/">No Rest DRR Brand</a>
        </div>
      </div>
