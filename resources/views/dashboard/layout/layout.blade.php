            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Home Tutor</span>
                    </a>
                ...
                <ul class="menu-inner bg-dark py-1">
                    <!-- Dashboard -->
                    <li class="menu-item pt-4 active">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Tuitor</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('tuitor')}}" class="menu-link">
                            ...
                            <li class="menu-item">
                                <a href="pages-account-settings-connections.html" class="menu-link">
                                    <div data-i18n="Connections">Delete Tuitor</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Tuition </div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('tuition')}}" class="menu-link">
                                    <div data-i18n="Account">All Tuition</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{route('addtuition')}}" class="menu-link">
                                    <div data-i18n="Notifications">Add Tuition</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{route('tuition')}}" class="menu-link">
                                    <div data-i18n="Connections">Delete Tuition</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Class </div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="pages-account-settings-connections.html" class="menu-link">
                                    <div data-i18n="Connections">Delete Class</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Subject </div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Day
                            </div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Social_Media </div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
